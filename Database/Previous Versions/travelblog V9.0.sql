...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 18, 2019 at 06:05 PM
...
(5, 3, 'Cats in Greece 2', 'Test update content for Cats in Greece blog post.', 13, 5, 1, '2019-04-15', 0, 1),
...
--
ALTER TABLE `blog`
  MODIFY `BlogID` smallint(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `user`
  MODIFY `UserID` smallint(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
